(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hike__slider")) new core(".hike__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    const delay = 5e3;
    let bgImagesList = document.querySelectorAll(".welcom__bg-image");
    setInterval((function() {
        for (let i = 0; i < bgImagesList.length; i++) if (bgImagesList[i].classList.contains("_bg-active")) if (i + 2 <= bgImagesList.length) {
            bgImagesList[i + 1].classList.add("_bg-active");
            bgImagesList[i].classList.remove("_bg-active");
            break;
        } else {
            bgImagesList[0].classList.add("_bg-active");
            bgImagesList[i].classList.remove("_bg-active");
            break;
        }
    }), delay);
    const delaycompetitions = 5e3;
    let bgcompetitionsImagesList = document.querySelectorAll(".contests__image");
    setInterval((function() {
        for (let i = 0; i < bgcompetitionsImagesList.length; i++) if (bgcompetitionsImagesList[i].classList.contains("_bd-con-active")) if (i + 2 <= bgcompetitionsImagesList.length) {
            bgcompetitionsImagesList[i + 1].classList.add("_bd-con-active");
            bgcompetitionsImagesList[i].classList.remove("_bd-con-active");
            break;
        } else {
            bgcompetitionsImagesList[0].classList.add("_bd-con-active");
            bgcompetitionsImagesList[i].classList.remove("_bd-con-active");
            break;
        }
    }), delaycompetitions);
    const delayolimpic = 5e3;
    let bgolompicImagesList = document.querySelectorAll(".olimpics__image");
    setInterval((function() {
        for (let i = 0; i < bgolompicImagesList.length; i++) if (bgolompicImagesList[i].classList.contains("_bd-ol-active")) if (i + 2 <= bgolompicImagesList.length) {
            bgolompicImagesList[i + 1].classList.add("_bd-ol-active");
            bgolompicImagesList[i].classList.remove("_bd-ol-active");
            break;
        } else {
            bgolompicImagesList[0].classList.add("_bd-ol-active");
            bgolompicImagesList[i].classList.remove("_bd-ol-active");
            break;
        }
    }), delayolimpic);
    const delayconference = 5e3;
    let bgconderenceImagesList = document.querySelectorAll(".conference__image");
    setInterval((function() {
        for (let i = 0; i < bgconderenceImagesList.length; i++) if (bgconderenceImagesList[i].classList.contains("_bd-cf-active")) if (i + 2 <= bgconderenceImagesList.length) {
            bgconderenceImagesList[i + 1].classList.add("_bd-cf-active");
            bgconderenceImagesList[i].classList.remove("_bd-cf-active");
            break;
        } else {
            bgconderenceImagesList[0].classList.add("_bd-cf-active");
            bgconderenceImagesList[i].classList.remove("_bd-cf-active");
            break;
        }
    }), delayconference);
    const delayArticle = 5e3;
    let bgArticleImagesList = document.querySelectorAll(".articles__image");
    setInterval((function() {
        for (let i = 0; i < bgArticleImagesList.length; i++) if (bgArticleImagesList[i].classList.contains("_bd-art-active")) if (i + 2 <= bgArticleImagesList.length) {
            bgArticleImagesList[i + 1].classList.add("_bd-art-active");
            bgArticleImagesList[i].classList.remove("_bd-art-active");
            break;
        } else {
            bgArticleImagesList[0].classList.add("_bd-art-active");
            bgArticleImagesList[i].classList.remove("_bd-art-active");
            break;
        }
    }), delayArticle);
